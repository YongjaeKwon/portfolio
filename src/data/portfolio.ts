...
export const featuredProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    card: {
      ...
      result: "pytest 205개·Vitest 95개와 프로덕션 빌드를 통과했고, 실제 계좌 조회와 KRX 데이터 적재, 자동 실행 경보와 전략 연구 배치를 검증했습니다.",
    ...
    detail: {
      ...
      results: [
        "2026년 8월 11일 기준 pytest 205개와 Vitest 95개가 통과했고 React 프로덕션 빌드를 확인했습니다.",
    ...
    perspectives: {
      frontend: {
        card: {
          ...
          result: "Vitest 95개와 프로덕션 빌드를 통과했고, JavaScript 번들을 gzip 140.28KB로 유지했습니다.",
      ...
      backend: {
        card: {
          ...
          result: "pytest 205개를 통과했고, 토스증권 계좌 조회와 KRX 5개 종목 × 10개 일봉 50행의 실제 적재를 확인했습니다.",
