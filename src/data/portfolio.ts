export const profile = {
  ...
  headline:
    "운영자가 매일 쓰는 업무 화면을 안정적으로 구현합니다.",
  summary:
    "B2B·B2G 운영 시스템에서 관리자 화면, 모바일 업무 화면, API 연동, MyBatis SQL, 메일·파일·인증 연동을 다뤄온 프론트엔드 중심 웹 개발자입니다. Vue, WebSquare, JSP, Nexacro 기반 화면을 개발하며 등록, 업로드, 발송, 조회, 이력 확인처럼 운영자가 반복하는 업무 흐름을 끊기지 않게 구현했습니다.",
  target:
...
export const focusTracks: Array<{
...
}> = [
  {
    ...
    headline:
      "Vue 기반 관리자 화면과 운영 업무 UI를 주력으로 구현합니다.",
    target:
    ...
    strengths: [
      ...
      {
        title: "관리자 UI 반복 구현",
        description: "검색 조건, 그리드, 상세, 모달, 파일 업로드, 엑셀 다운로드 화면에서 loading/empty/error/disabled 상태를 업무 단계에 맞춰 분리해 구현했습니다.",
        icon: "PanelTop",
      },
      {
        title: "조회 조건 일관성 검증",
  ...
  },
  {
    ...
    strengths: [
      ...
      {
        title: "외부 연동 결과 처리",
        description: "메일·파일·엑셀·인증·알림 발송처럼 실패 케이스가 있는 기능에서 요청, 처리, 결과 표시 흐름을 함께 구현했습니다.",
        icon: "MonitorSmartphone",
      },
    ],
    fitItems: [
  ...
  },
  {
    id: "fullstack",
    label: "Spring/API",
    role: "Frontend-oriented Web Developer",
    badge: "Spring/API · Web",
    headline:
    ...
    fitItems: [
      ...
      },
      {
        label: "인증·파일·메일 연동",
        description:
          "인증, 파일 업로드, 엑셀 다운로드, 메일·알림 발송 결과를 화면과 서버 흐름으로 함께 다뤘습니다.",
        icon: "RadioTower",
      },
      {
        label: "데이터 조건 처리",
...
export const projects = [
  {
    ...
    summary:
      "수십 개 협력사가 사용하는, 협력사·고객사 담당자·교육·계약·공지·설문 관리용 Spring Boot 3 기반 B2B 운영 포탈입니다. Vue 화면·Tabulator 그리드·Spring Boot API·MyBatis SQL을 전담하며 포탈 전반의 화면을 두루 담당했고, 교육 등록→대상자 업로드→메일 발송→제출 현황 조회까지 이어지는 관리자 업무 흐름을 처음부터 끝까지 구현했습니다.",
    highlights: [
      ...
      "2단계 인증, 접근 예외, 사용자 유형별 접근 조건이 서버 판단과 화면 접근에서 같은 기준으로 동작하도록 케이스를 나눠, 로그인이 잘못 분기되던 문제 제거",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "알림톡 등 외부 메시지 발송 채널처럼 '요청 성공 ≠ 실제 발송'인 기능에서, 발송 결과를 성공·실패·대기·재처리 등 4가지 이상 상태로 분리해 운영자가 확인·재처리할 수 있게 반영",
...
export const techGroups = [
  {
    title: "Frontend",
    icon: "Code",
    items: ["HTML5", "CSS3", "SASS/SCSS", "JavaScript", "Vue.js", "WebSquare", "JSP", "Nexacro", "jQuery", "TypeScript", "React", "Next.js", "Zustand", "Pinia", "Redux", "React Query", "React Hook Form", "Canvas"],
  },
  {
    title: "Backend",
    icon: "Server",
